...
.card::before{
  ...
  background:linear-gradient(145deg,rgba(255,255,255,.07) 0%,transparent 50%);
  pointer-events:none;
}
...
.app-name{font-size:1rem;font-weight:700;letter-spacing:-.02em;}
.app-sub{font-size:10px;color:var(--txt2);margin-top:1px;font-weight:500;}
.live-pill{
  display:flex;align-items:center;gap:5px;
  background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.12);
  border-radius:20px;padding:5px 10px;
  font-size:10px;font-weight:700;letter-spacing:.06em;color:var(--txt2);
}
...
@media(max-width:680px){
  ...
  /* reset all area placements */
  .a-cam,.a-stat,.a-servo,.a-ctrl{grid-column:1;grid-row:auto;}
  /* hide desktop-only panels on mobile */
  .a-stat,.a-servo,.desktop-only{display:none !important;}
}
...
.hud-k{font-size:9px;text-transform:uppercase;letter-spacing:.1em;
  color:var(--txt2);font-weight:700;margin-bottom:2px;}
.hud-v{font-size:.85rem;font-weight:800;font-variant-numeric:tabular-nums;}
...
.sv-num{font-size:2.2rem;font-weight:800;letter-spacing:-.04em;line-height:1;}
...
input[type=range]{
  ...
  background:linear-gradient(to right,#fff var(--pct,50%),rgba(255,255,255,.15) var(--pct,50%));
  outline:none;cursor:pointer;margin-bottom:10px;
}
input[type=range]::-webkit-slider-thumb{
  -webkit-appearance:none;width:18px;height:18px;border-radius:50%;
  background:#fff;border:none;
  box-shadow:0 0 0 3px rgba(255,255,255,.15),0 2px 8px rgba(0,0,0,.5);
...
.sv-btn:hover{background:rgba(255,255,255,.12);}
.sv-btn:active{background:rgba(255,255,255,.22);}
...
.d-btn{
  ...
  color:var(--txt);font-size:1.15rem;
  display:flex;align-items:center;justify-content:center;
  cursor:pointer;
  transition:background .06s,transform .05s;
  touch-action:manipulation;font-family:var(--rf);
}
.d-btn:active{background:rgba(255,255,255,.18);transform:scale(.9);}
.d-stp{background:rgba(255,67,58,.10);border-color:rgba(255,67,58,.25);color:var(--red);}
...
.joy-tag{
  ...
  font-size:10px;color:var(--txt2);font-weight:600;font-variant-numeric:tabular-nums;
}
.joy-tag b{color:var(--txt);}
...
.btn-stop{
  ...
  box-shadow:0 0 0 1px rgba(255,67,58,.5),0 4px 20px rgba(255,67,58,.3);
}
...
(function(){
  ...
  function draw(){
    ...
    // Outer subtle glow
    if(mag>0.06){
      var gO=ctx.createRadialGradient(CX,CY,OR-2,CX,CY,OR+14);
      gO.addColorStop(0,'rgba(255,255,255,'+(mag*.07)+')');
      gO.addColorStop(1,'transparent');
      ctx.beginPath();ctx.arc(CX,CY,OR+14,0,Math.PI*2);
    ...
    // Track ring
    ctx.beginPath();ctx.arc(CX,CY,OR,0,Math.PI*2);
    ctx.strokeStyle=on?'rgba(255,255,255,.30)':'rgba(255,255,255,.12)';
    ctx.lineWidth=1.5;ctx.stroke();

    // Inner tick marks (Apple-style)
    ...
    if(mag>0.04){
      ...
      ctx.strokeStyle='rgba(255,255,255,'+(0.1+mag*0.4)+')';
      ctx.lineWidth=2;ctx.stroke();
    }

    // Magnitude ring
    if(mag>0.08){
      ctx.beginPath();ctx.arc(kx,ky,KR+8,0,Math.PI*2);
      ctx.strokeStyle='rgba(255,255,255,'+(mag*.2)+')';
      ctx.lineWidth=2;ctx.stroke();
    }
    ...
    // Knob body
    var kg=ctx.createRadialGradient(kx-10,ky-10,1,kx,ky,KR);
    if(on){
      kg.addColorStop(0,'#ffffff');
      kg.addColorStop(1,'rgba(200,200,200,.9)');
    } else {
      kg.addColorStop(0,'rgba(200,200,200,.3)');
      kg.addColorStop(1,'rgba(100,100,100,.2)');
    }
    ctx.beginPath();ctx.arc(kx,ky,KR,0,Math.PI*2);
    ctx.fillStyle=kg;ctx.fill();
    ctx.shadowBlur=0;
    ctx.strokeStyle=on?'rgba(255,255,255,.6)':'rgba(255,255,255,.12)';
    ctx.lineWidth=1.5;ctx.stroke();

    // Centre pip
    ctx.beginPath();ctx.arc(kx,ky,5,0,Math.PI*2);
    ctx.fillStyle=on?'rgba(0,0,0,.5)':'rgba(255,255,255,.10)';
    ctx.fill();
  }
