...
.d-btn:active{background:#1C1C1E;color:#fff;transform:scale(.9);}
.d-stp{background:rgba(255,59,48,.12);border-color:rgba(255,59,48,.3);color:var(--red);}
