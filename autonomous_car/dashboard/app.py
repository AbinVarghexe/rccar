...
/* ─────────────────────────────────────────────────────────────
   MOBILE OVERRIDES (SERVO CONTROL & MEDIA SAVE ENABLED)
───────────────────────────────────────────────────────────── */
@media(max-width:680px){
  ...
  /* Reset all area placements for clean single column flow */
  .a-cam,.a-stat,.a-servo,.a-ctrl{grid-column:1;grid-row:auto;}
  /* Ensure Servo Motor Control and Telemetry are fully visible on mobile */
  .a-stat,.a-servo{display:block !important;}
}
